  ...
  #;;;***  STUDIEN-NAME   : VaS-Projekt                            ***;;;
  #;;;***  STUDIEN-NUMMER :                                        ***;;;
  #;;;***  SPONSOR        :                                        ***;;;
  #;;;***  ARBEITSBEGIN   : 15.11.2022                             ***;;;
  #;;;****************************************************************;;;
  #;;;*--------------------------------------------------------------*;;;
  #;;;*---  PROGRAMM      : MAIN_VAS2023.au3                      ---*;;;
  #;;;*---  Parent        : RealWord.au3                          ---*;;;
  #;;;*---  BESCHREIBUNG  : System für KI                         ---*;;;
  #;;;*---                :                                       ---*;;;
  #;;;*---                :                                       ---*;;;
  #;;;*---  VERSION   VOM : 15.11.2022                            ---*;;;
  #;;;*--   KORREKTUR VOM : 05.12.2022, 06.12.2022                ---*;;;
  #;;;*--                 :                                       ---*;;;
  #;;;*---  INPUT         :.INI                                   ---*;;;
  #;;;*---  OUTPUT        :                                       ---*;;;
  #;;;*--------------------------------------------------------------*;;;
  ...
  #;;;  Wann              :               Was                        *;;;
  #;;;*--------------------------------------------------------------*;;;
  #;;;* 15.11.2022        : Basis-Aufbau                             *;;;
  #;;;* 05.12.2022        : RadioBox                                 *;;;
  #;;;* 06.12.2022        : Open Py-Script, neu OpenWord             *;;;
  #;;;*---                :                                       ---*;;;
  #;;;****************************************************************;;;
...
os.chdir("E:/IPYNB/KSFE2023/")
form = Document(docx = "E:\IPYNB\KSFE2023\INDATEN\Tables.docx")
df = pd.read_csv('E:\\IPYNB\\KSFE2023\\DATEN\\Export.csv')
df3=df[(df['GR']==2)]
df3=df3.drop(['GR','NN'], axis=1)
Kopf = ['red', '#9C0C38', 'orange']
n_rows, n_cols = df3.shape[0], df3.shape[1] 

country = pd.read_csv('E:\\IPYNB\\KSFE2023\\INDATEN\\Country1.csv')
input_doc = Document('E:\\IPYNB\\KSFE2023\\INDATEN\\Para1.docx')
front_doc = Document('E:\\IPYNB\\KSFE2023\\INDATEN\\front.docx')

text_file = open('E:\\IPYNB\\KSFE2023\\INDATEN\\TxtGrVor.txt', "r")
data = text_file.read()
text_file.close()
...
def xtables():
    ...
    for k in range (0, 22): 
        ...
        df3=df3.drop(['GR','NN'], axis=1)
        n_rows, n_cols = df3.shape[0], df3.shape[1]  
        picPath = "E:\\IPYNB\\KSFE2023\\OUTPUT\\GRAPH" + str(k+1) + ".png"
        ...
        run = paragraph.add_run()
        run.add_picture("E:\\IPYNB\\KSFE2023\\INDATEN\\who-logo-png.png", Cm(1), Cm(1))
...
def post_page():
    ...
    paragraph = cell.paragraphs[0]
    run = paragraph.add_run()
    run.add_picture("E:\\IPYNB\\KSFE2023\\INDATEN\\KI3.jpg")
...
def open_doc():
    docx_file = "E:\\IPYNB\\KSFE2023\\OUTPUT\\AVaS2023Finish.docx" 
...
picPath = "E:\\IPYNB\\KSFE2023\\INDATEN\\KI.jpg"    
p = doc.add_paragraph(" ")
r = p.add_run()
...
xmain()
print("AVaS2023Finish.docx ist da!")